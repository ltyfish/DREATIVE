...
export const DELIVERY_PROFILES: readonly DeliveryProfile[] = [
  {
    ...
    scope: "A complete, coherent redesign with the treatments and mechanisms that genuinely improve the concept, on a route-wide interaction baseline.",
    treatments: "Agent-selected; UX, Mobile, and the interaction baseline always apply. Spread small motion across the route before funding a second signature moment.",
    review: "lean",
    prototype: "auto",
  ...
  },
  {
    ...
    scope: "A flagship experience whose ambition is distributed beyond one isolated spectacle, using the strongest coherent combination of media, motion, interaction, spatial depth, and responsive craft — distributed as resolution per section, not elements per section.",
