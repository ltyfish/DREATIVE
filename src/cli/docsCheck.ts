...
export function runDocsCheck(skillDir: string): DocsCheckReport {
  ...
  // 2026-08-27: a round shipped a page whose entire motion layer was transforms on DOM
  // boxes with nothing downloaded for it, because nothing in the contract said the
  // material was the decision. Motion is this skill's depth, not its scope — the
  // specialization was reverted the same day; these pins are the part that survived.
