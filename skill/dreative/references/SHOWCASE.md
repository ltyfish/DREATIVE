...
## One connected experience system
...
Showcase contracts must be portable tracked files. Ignored, untracked, missing,
absolute-machine, or inline-only evidence blocks completion.
...
the primary subject. Continuity remains canonical in the continuity contract.
...
Ask the user for the independent visual verdict; you cannot author it.
